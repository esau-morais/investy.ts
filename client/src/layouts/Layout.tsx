...
export default function Layout({ children }: { children: React.ReactNode }) {
  return (
    <div className="w-full min-h-screen antialiased bg-[#0e0c0b] selection:bg-pink-200 selection:text-black px-8">
      ...
      <main className="relative z-10 grid w-full h-auto min-h-screen pt-16 grid-rows-auto">
        {children}
      </main>
    </div>
  )
